...
public class CharcaterView : UIBinder
{
    ...
    public void Init()
    {
        ...
        GetUI<TMP_Text>("RecoverHpText").text = Util.GetText($"RecoveryHp/S : {_model.RecoverHpPerSecond}").ToString();
        ...
        GetUI<TMP_Text>("CriticalChanceText").text = Util.GetText($"Critical : {_model.CriticalChance}").ToString();
    }
    #endregion
    ...
    public void UpdateRerecoverHpPerSecond() => GetUI<TMP_Text>("RecoverHpText").text = Util.GetText($"RecoveryHp/S : {_model.RecoverHpPerSecond}").ToString();
    ...
    public void UpdateCriticalChance() => GetUI<TMP_Text>("CriticalChanceText").text = Util.GetText($"Critical : {_model.CriticalChance}").ToString();
